    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.containerInput}>
                <View style={{display:'flex',flexDirection:'row',borderWidth:1,marginRight:10,marginLeft:10,borderRadius:20,backgroundColor:"#DCDCDC",alignItems:"center", marginBottom:10, marginTop:-50}}>
                    <View style={{flex:0.15,alignItems:'center'}}>
                        <Feather name="phone" size={32} color="black" />
                    </View>
                    <TextInput onChangeText={x=>setPhone(x)} value={phone} placeholder="Vui lòng nhập số điện thoại" style={{marginRight:15,height:50,fontSize:22,flex:0.85}} keyboardType="phone-pad"/>
                </View>
