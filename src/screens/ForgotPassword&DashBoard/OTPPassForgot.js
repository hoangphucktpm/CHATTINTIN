...
import styles from "./StyleOTPPassForgot";
import { useState } from "react";
import { useNavigation } from "@react-navigation/native";


// Import FireBase
const OTPPassForgot = (props) => {
    ...
    const hanldPressRegister = () => {
        if (otp === "") {
            ...
            navigation.navigate("ChangePassForgot", { phoneNumber: phoneNumber });
            // })
            // .catch(error => {
