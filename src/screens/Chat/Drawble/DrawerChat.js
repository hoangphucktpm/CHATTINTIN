...
function DrawerChat({ navigation }) { // Add navigation prop here
  const [isDialogVisible, setIsDialogVisible] = useState(false);
  const [nameChange, setnameChange] = useState("AppTinTin");
  const [isBFF, setIsBFF] = useState(false);
  const [avtChange, setavtChange] = useState("https://st.quantrimang.com/photos/image/2021/05/21/AVT-Doi11-1.jpg");
    ...
    <Provider>
        ...
        <TouchableOpacity onPress={hanldPressGoBack} style={styles.button}>
            <MaterialIcons name="keyboard-arrow-left" size={32} color="white" />
                ...
                <View style={{width:"73%",paddingTop:10, paddingLeft:10, paddingBottom:10,}}>
        ...
        <ScrollView style={{paddingBottom: 600}}>
            <View style={styles.containerBody}>
                <View style={styles.containerBody_Top}>
                    <Image style={styles.containerBody_Top_Avt} 
